...
public class Gui
{
    ...
    public static void drawRect2(double x, double y, double width, double height, int color) {
        ...
        bufferBuilder.pos(x, y, 0.0D).color(color).endVertex();
        bufferBuilder.pos(x, y + height, 0.0D).color(color).endVertex();
        bufferBuilder.pos(x + width, y + height, 0.0D).color(color).endVertex();
        bufferBuilder.pos(x + width, y, 0.0D).color(color).endVertex();
        tessellator.draw();
