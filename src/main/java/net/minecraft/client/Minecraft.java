...
public class Minecraft implements IThreadListener, ISnooperInfo
{
    ...
    {
        EventShutdown eventShutdown = new EventShutdown();
        Client.INSTANCE.getEventManager().call(eventShutdown);
        this.running = false;
    }
    ...
    public void runTick() throws IOException
    {
        ...
        Client.INSTANCE.getEventManager().call(eventTick);
    ...
    private void runTickKeyboard() throws IOException
    {
        while (Keyboard.next())
        {
            ...
            if (Keyboard.getEventKeyState() && currentScreen == null) {
                EventInputKey eventInputKey = new EventInputKey(i);
                Client.INSTANCE.getEventManager().call(eventInputKey);
            }
